...
class Student(Base):
    ...
    programme = Column(Enum("btech", "mtech", "phd"), nullable=True,name='programme_enum')
...
class Appointment(Base):
    ...
    status = Column(Enum("pending", "approved", "rejected", "cancelled","blocked"), default="pending", name="status")
