        ...
        <div className="flex flex-col h-full space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
                <div>
                    ...
                    <p className="text-sm border-s border-blue-500 pl-2 text-gray-500 mt-1">Review and manage student queues.</p>
                </div>
            </div>

            <div className="flex space-x-1 p-1 bg-gray-100 rounded-xl w-max shadow-inner">
                <button
            ...
            <div className="grid gap-4 flex-1 overflow-y-auto pb-4">
                        ...
                        <CardContent className="p-5 flex flex-col md:flex-row gap-5 justify-between">
                            <div className="flex gap-4 items-start">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="mt-3 bg-gray-50 p-3 rounded-xl border border-gray-100 inline-block w-full">
                ...
                {activeTab === "history" && historyRequests.length === 0 && (
                    <Card className="p-8 text-center text-gray-500 flex flex-col items-center justify-center h-48 border-dashed border-2 shadow-none">
                        ...
                        <p>No confirmed requests to show right now.</p>
                    </Card>
                )}
            </div>
